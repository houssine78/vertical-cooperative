...
<body>
    ...
    <h1 style="clear: both; padding-bottom: 5px; border-bottom: #e36522 1px solid;width: 150px;text-align: center">
    ...
    <table class="info_table" width="100%">
        ...
        <tr>
            <td style="text-align: center;border-right: #e36522 1px solid;" class="date">${formatLang(inv.date_invoice, date=True)}</td>
            <td style="text-align: center;border-right: #e36522 1px solid;" class="date">${formatLang(inv.date_due, date=True)}</td>
            <td style="text-align: left;text-indent:20px;border-right: #e36522 1px solid;"> ${inv.object or ''}</td>
    ...
    <hr style="border-top : 1px solid #ff7f00;" width="100%">
    
    <table class="list_line_table_head" style="margin-top:10px ;margin-left:50%; margin-bottom:10px;border:1px solid #ff7f00;" width="50%">
			<tr></tr>
			<tr>
                <th width="25%" style="text-indent:5px;border-bottom:1px solid #ff7f00" ><b>${_("Taux")}</b></th>
                <th width="10%" style="text-align:center;border-bottom:1px solid #ff7f00" ><b>${_("Base TVA")}</b></th>
                <th width="15%" style="text-align:center;border-bottom:1px solid #ff7f00" ><b>${_("Taxe")}</b></th>
            </tr>
    ...
    <hr style="margin-left:50%;border-top : 1px solid #ff7f00;" width="50%">
    
    <table style="margin-top:10px ;margin-left:50%; margin-bottom:10px;border:1px solid #ff7f00;" width="50%">
			<tr>
